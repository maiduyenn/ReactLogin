    ...
    return (
        <ThemeProvider theme={theme}>
            <Grid container component="main" sx={{ height: '100vh' }}>
                <CssBaseline />
                <Grid item xs={12} sm={6} md={6} component={Paper} elevation={6} square sx={{ height: '842px', width: "543px", padding: "50px" }} >
                    <Box
                        sx={{
                            my: 8,
                            mx: 4,
                    ...
                    >
                        ...
                        <Typography component="h1" variant="h6" sx={{ fontWeight: "400", fontSize: "16px", mb: 3, mt: 1 }}>
                ...
                >
                    ...
                    />
                    <Typography component="h1" variant="h5" align="center" color="white" sx={{ fontWeight: "600", fontSize: "40px" }}>
                        Trung tâm thông tin quy hoạch và xác minh thửa đất Landmaps
                    </Typography>

                    <Typography component="h1" variant="h5" align="center" color="white" sx={{ fontWeight: "500", fontSize: "18px", mt: 3 }}>
                        Công cụ hỗ trợ cho các nhà đầu tư, chuyên viên môi giới, sàn giao dịch, công ty tài chính... tra cứu thông tin quy hoạch và xác minh tính pháp lý thửa đất bởi cơ quan nhà nước, với mục tiêu là hạn chế tủi ro và nâng cao tính an toàn trong chuyển nhượng bất động sản
